...
e = 0.100; %сторона подвижной платформы
f = 0.400; %сторона неподвижной платформы
re = 0.250; % длина звена подвижная платформа - шарнир
rf = 0.120; % длина звена неподвижная платформа - шарнир
